  ...
  if (
    ...
    Plotly.newPlot(
      ...
      ],
      {
        ...
        xaxis: { range: [0, 0.061], title: "<b>Time(s)</b>", fixedrange: true },
        yaxis: {
          range: [-1 * 0.1 * a[0][0], a[0][0] + 0.1 * a[0][0] + 1],
          title: "<b>Voltage(V)</b>",
          fixedrange: true,
        },
        margin: { t: 35 },
...
function generateGraph() {
  ...
  for (let x = 0; x <= 0.06; x += 0.00001) {
    ...
    if (x > g1time) {
      if (x < g2time) {
        volt = sine1;
        if (volt > 0) {
          output_voltage.push(sine1);
          output_current.push(sine1 / resistance);
          thy1.push(0);
          thy2.push(sine2 - sine1);
          thy3.push(sine3 - sine1);
        ...
        volt = sine2;
        if (volt > 0) {
          output_voltage.push(sine2);
          output_current.push(sine2 / resistance);
          thy1.push(sine1 - sine2);
          thy2.push(0);
          thy3.push(sine3 - sine2);
        ...
        volt = sine3;
        if (volt > 0) {
          output_voltage.push(sine3);
          output_current.push(sine3 / resistance);
          thy1.push(sine1 - sine3);
          thy2.push(sine2 - sine3);
          thy3.push(0);
          vrms = vrms + sine3 * sine3;
          vavg = vavg + sine3;
        } else {
          output_voltage.push(0);
          output_current.push(0);
  ...
  max_volt = Math.max([ac1aap, ac2app, ac3app]);
  var max_volt_new =
    max_volt + Math.max([ac1aap, ac2app, ac3app].pop(max_volt));
  ...
  values["irms"] = irms;
  return [
    [max_volt, max_volt / resistance, max_volt_new],
    [input_sine1, xval],
    [input_sine2, xval],
    [input_sine3, xval],
    [output_voltage, xval],
